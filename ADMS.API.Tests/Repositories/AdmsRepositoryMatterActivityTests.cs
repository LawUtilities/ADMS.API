...
{
    /// <summary>
    /// Unit tests for <see cref="AdmsRepository.GetMatterActivityByActivityNameAsync"/>.
    /// </summary>
    public class AdmsRepositoryMatterActivityTests
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdmsRepositoryMatterActivityTests"/> class.
        /// </summary>
        public AdmsRepositoryMatterActivityTests()
        {
        ...
        /// </summary>
        [Fact]
        public async Task GetMatterActivityByActivityNameAsync_ReturnsNull_WhenActivityNameIsNull()
        {
            // Arrange
...
#pragma warning restore CS8604 // Possible null reference argument.
            ...
            // Act
#pragma warning disable CS8604 // Possible null reference argument.
            var result = await repo.GetMatterActivityByActivityNameAsync(activityName);
#pragma warning restore CS8604 // Possible null reference argument.
        ...
        /// </summary>
        [Fact]
        public async Task GetMatterActivityByActivityNameAsync_ReturnsNull_WhenActivityNameIsEmpty()
        {
            // Arrange
            string activityName = "";
            _validationServiceMock
        ...
        /// </summary>
        [Fact]
        public async Task GetMatterActivityByActivityNameAsync_ReturnsNull_WhenActivityNameIsWhitespace()
        {
            // Arrange
            string activityName = "   ";
            _validationServiceMock
        ...
        /// </summary>
        [Fact]
        public async Task GetMatterActivityByActivityNameAsync_ReturnsNull_WhenActivityNotFound()
        {
            // Arrange
            ...
            _loggerMock.Verify(
                l => l.Log(
                    LogLevel.Warning,
                    It.IsAny<EventId>(),
                    It.Is<It.IsAnyType>((v, t) => v.ToString()!.Contains("No MatterActivity found")),
                    null,
                    It.IsAny<Func<It.IsAnyType, Exception?, string>>()),
                Times.Once);
        }
        ...
        /// </summary>
        [Fact]
        public async Task GetMatterActivityByActivityNameAsync_ReturnsActivity_WhenFound()
        {
            // Arrange
        ...
        /// </summary>
        [Fact]
        public async Task GetMatterActivityByActivityNameAsync_ReturnsNull_WhenMultipleActivitiesExist()
        {
            // Arrange
            ...
            await using (var context = new AdmsContext(_dbContextOptions))
            {
                context.MatterActivities.Add(new MatterActivity
                {
                    Id = Guid.NewGuid(),
                    Activity = activityName
                });
            ...
            _loggerMock.Verify(
                l => l.Log(
                    LogLevel.Error,
                    It.IsAny<EventId>(),
                    It.Is<It.IsAnyType>((v, t) => v.ToString()!.Contains("Multiple MatterActivity records found")),
                    It.IsAny<Exception>(),
                    It.IsAny<Func<It.IsAnyType, Exception?, string>>()),
                Times.Once);
        }
        ...
        /// </summary>
        [Fact]
        public async Task GetMatterActivityByActivityNameAsync_ReturnsNull_OnUnexpectedException()
        {
            // Arrange
            ...
            contextMock.Setup(c => c.MatterActivities)
