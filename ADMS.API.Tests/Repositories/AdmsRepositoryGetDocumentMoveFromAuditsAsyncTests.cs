...
namespace ADMS.API.Tests.Repositories
{
    ...
    /// </summary>
    public class AdmsRepositoryGetDocumentMoveFromAuditsAsyncTests
    {
        ...
        /// </summary>
        [Fact]
        public async Task GetDocumentMoveFromAuditsAsync_ReturnsBadRequest_WhenDocumentIdIsEmpty()
        {
            // Arrange
            ...
            // Act
            var result = await repo.GetPaginatedDocumentMoveFromAuditsAsync(Guid.Empty, resourceParams);
        ...
        /// </summary>
        [Fact]
        public async Task GetDocumentMoveFromAuditsAsync_ReturnsBadRequest_WhenResourceParametersIsNull()
        {
            // Arrange
            var context = CreateInMemoryContext();
            var repo = CreateRepository(context);
...
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
            var result = await repo.GetPaginatedDocumentMoveFromAuditsAsync(Guid.NewGuid(), null);
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        /// </summary>
        [Fact]
        public async Task GetDocumentMoveFromAuditsAsync_ReturnsBadRequest_WhenPageNumberIsInvalid()
        {
            // Arrange
            var context = CreateInMemoryContext();
            var repo = CreateRepository(context);
            ...
            // Act
            var result = await repo.GetPaginatedDocumentMoveFromAuditsAsync(Guid.NewGuid(), resourceParams);
        ...
        /// </summary>
        [Fact]
        public async Task GetDocumentMoveFromAuditsAsync_ReturnsBadRequest_WhenPageSizeIsInvalid()
        {
            // Arrange
            var context = CreateInMemoryContext();
            var repo = CreateRepository(context);
        ...
        public async Task GetDocumentMoveFromAuditsAsync_ReturnsNotFound_WhenDocumentDoesNotExist()
        {
            ...
            // Act
            var result = await repo.GetPaginatedDocumentMoveFromAuditsAsync(docId, resourceParams);
        ...
        /// </summary>
        [Fact]
        public async Task GetDocumentMoveFromAuditsAsync_Returns500_WhenValidationThrows()
        {
            // Arrange
            var context = CreateInMemoryContext();
            var docId = Guid.NewGuid();
        ...
        /// </summary>
        [Fact]
        public async Task GetDocumentMoveFromAuditsAsync_ReturnsPagedList_SortedByCreatedAtDescending_WhenNoOrderBy()
        {
            // Arrange
            var context = CreateInMemoryContext();
            var docId = Guid.NewGuid();
            ...
            var audits = new List<MatterDocumentActivityUserFrom>
            {
                new() {
                    DocumentId = docId,
            ...
            context.MatterDocumentActivityUsersFrom.AddRange(audits);
        ...
        /// </summary>
        [Fact]
        public async Task GetDocumentMoveFromAuditsAsync_ReturnsPagedList_SortedByActivity_WhenOrderByActivity()
        {
            // Arrange
            var context = CreateInMemoryContext();
            var docId = Guid.NewGuid();
        ...
        /// </summary>
        [Fact]
        public async Task GetDocumentMoveFromAuditsAsync_ReturnsPagedList_SortedByCreatedAtDescending_WhenOrderByCreatedAt()
        {
            // Arrange
            var context = CreateInMemoryContext();
            var docId = Guid.NewGuid();
        ...
        /// </summary>
        [Fact]
        public async Task GetDocumentMoveFromAuditsAsync_ReturnsEmptyPagedList_WhenNoAuditsExist()
        {
            // Arrange
            var context = CreateInMemoryContext();
            var docId = Guid.NewGuid();
        ...
        /// </summary>
        [Fact]
        public async Task GetDocumentMoveFromAuditsAsync_ReturnsPagedList_WithCorrectPaging()
        {
            // Arrange
            var context = CreateInMemoryContext();
            var docId = Guid.NewGuid();
            ...
            for (int i = 0; i < 5; i++)
            {
                context.MatterDocumentActivityUsersFrom.Add(new MatterDocumentActivityUserFrom
                {
                    DocumentId = docId,
                    MatterDocumentActivityId = activity.Id,
                    MatterDocumentActivity = activity,
        ...
        /// </summary>
        [Fact]
        public async Task GetDocumentMoveFromAuditsAsync_ReturnsEmptyPagedList_WhenExceptionOccurs()
        {
            // Arrange
            var context = CreateInMemoryContext();
            var docId = Guid.NewGuid();
