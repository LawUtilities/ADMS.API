...
{
    /// <summary>
    /// Unit tests for <see cref="DocumentController.CheckinDocumentAsync"/>.
    /// </summary>
    public class DocumentControllerCheckinDocumentAsyncTests
    {
        ...
        /// </summary>
        [Fact]
        public async Task CheckinDocumentAsync_ReturnsBadRequest_WhenMatterIdEmpty()
        {
            var controller = CreateController();
            var result = await controller.CheckinDocumentAsync(Guid.Empty, Guid.NewGuid());
        ...
        /// </summary>
        [Fact]
        public async Task CheckinDocumentAsync_ReturnsBadRequest_WhenDocumentIdEmpty()
        {
            var controller = CreateController();
            var result = await controller.CheckinDocumentAsync(Guid.NewGuid(), Guid.Empty);
            Assert.IsType<BadRequestObjectResult>(result);
        }
        ...
        /// </summary>
        [Fact]
        public async Task CheckinDocumentAsync_ReturnsNotFound_WhenMatterOrDocumentNotFound()
        {
            var controller = CreateController();
            _validationServiceMock.Setup(v => v.ValidateMatterExistsAsync(It.IsAny<Guid>()))
                .ReturnsAsync(new NotFoundResult());
            var result = await controller.CheckinDocumentAsync(Guid.NewGuid(), Guid.NewGuid());
        ...
        /// </summary>
        [Fact]
        public async Task CheckinDocumentAsync_ReturnsOk_WhenCheckinSucceeds()
        {
            var controller = CreateController();
            ...
            _validationServiceMock.Setup(v => v.ValidateDocumentExistsAsync(documentId))
                .ReturnsAsync((ActionResult?)null);
            _repoMock.Setup(r => r.SetDocumentCheckStateAsync(documentId, false))
                .ReturnsAsync(true);

            var result = await controller.CheckinDocumentAsync(matterId, documentId);
        ...
        /// </summary>
        [Fact]
        public async Task CheckinDocumentAsync_ReturnsBadRequest_WhenCannotCheckin()
        {
            var controller = CreateController();
            var matterId = Guid.NewGuid();
            var documentId = Guid.NewGuid();
        ...
        /// </summary>
        [Fact]
        public async Task CheckinDocumentAsync_ReturnsInternalServerError_OnException()
        {
            var controller = CreateController();
            var matterId = Guid.NewGuid();
            var documentId = Guid.NewGuid();
