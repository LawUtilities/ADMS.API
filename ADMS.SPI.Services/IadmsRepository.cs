...
namespace ADMS.API.Services
{
    ...
    public interface IAdmsRepository
    {
        ...
        /// <returns>A list of documents</returns>
        Task<PagedList<Document>> GetDocumentsAsync(DocumentsResourceParameters documentsResourceParameters);
        ...
        Task<IEnumerable<DocumentActivityUser>> GetDocumentAuditsAsync(Guid documentId);
