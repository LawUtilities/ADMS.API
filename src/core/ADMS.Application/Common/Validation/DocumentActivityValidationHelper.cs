...
/// <summary>
/// Validation helper for document activities.
/// </summary>
public static class DocumentActivityValidationHelper
{
    /// <summary>
    /// Valid document activity types.
    /// </summary>
    public static readonly string[] AllowedActivities = 
    [
        "CHECKED IN", "CHECKED OUT", "CREATED", "DELETED", "RESTORED", "SAVED"
    ];
    ...
    /// <summary>
    /// Validates a document activity type.
    /// </summary>
