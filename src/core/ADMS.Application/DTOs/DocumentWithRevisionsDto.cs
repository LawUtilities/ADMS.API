...
public partial class DocumentWithRevisionsDto : IValidatableObject, IEquatable<DocumentWithRevisionsDto>
{
    ...
    /// <param name="requireAtLeastOne">If true, require at least one item in the collection.</param>
    ...
    /// </remarks>
    private static IEnumerable<ValidationResult> ValidateCollection<T>(ICollection<T> collection, string propertyName, bool requireAtLeastOne = false)
    {
