...
/// <summary>
/// Comprehensive Data Transfer Object representing the destination-side audit trail for document transfer operations between matters.
/// </summary>
/// <remarks>
/// This DTO serves as the complete representation of the "TO" side of document transfer audit trails within the ADMS legal 
/// document management system, corresponding to <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo"/>. It captures 
/// comprehensive information about document transfers (MOVE or COPY operations) TO a destination matter, providing essential 
...
/// <list type="bullet">
/// <item><strong>Destination-Side Audit Trail:</strong> Captures complete information about documents received into a matter</item>
...
/// <item><strong>Entity Synchronization:</strong> Mirrors all properties and relationships from ADMS.API.Entities.MatterDocumentActivityUserTo</item>
...
/// This DTO represents the composite primary key relationship from ADMS.API.Entities.MatterDocumentActivityUserTo:
/// <list type="bullet">
/// <item><strong>Matter Association:</strong> Destination matter receiving the document via MatterId and MatterWithoutDocumentsDto</item>
...
/// <list type="bullet">
/// <item><strong>MOVED:</strong> Documents moved TO this matter from another matter (source matter loses the document)</item>
/// <item><strong>COPIED:</strong> Documents copied TO this matter from another matter (source matter retains the document)</item>
/// </list>
/// 
/// <para><strong>Legal Practice Benefits:</strong></para>
/// <list type="bullet">
/// <item><strong>Document Provenance Tracking:</strong> Complete tracking of document sources and origins</item>
/// <item><strong>Client Notification Support:</strong> Enables client communication about document additions to matters</item>
/// <item><strong>Matter Completeness Validation:</strong> Supports quality assurance for matter organization</item>
/// <item><strong>Professional Responsibility:</strong> Complete user accountability for document custody changes</item>
...
/// <list type="bullet">
/// <item><strong>Source-Side Tracking:</strong> MatterDocumentActivityUserFromDto tracks the origin of transfers</item>
/// <item><strong>Destination-Side Tracking:</strong> This DTO tracks the destination of transfers</item>
...
/// <list type="bullet">
/// <item><strong>Matter Organization:</strong> Supports professional matter-based document organization strategies</item>
/// <item><strong>Client Service:</strong> Enables effective client communication about document locations and changes</item>
...
/// <list type="bullet">
/// <item><strong>Document Transfer Auditing:</strong> Primary use for tracking documents received into matters</item>
...
/// <item><strong>Client Communication:</strong> Informing clients about document additions and changes</item>
/// <item><strong>Administrative Operations:</strong> Document transfer oversight and quality assurance</item>
/// </list>
/// </remarks>
/// <example>
/// <code>
/// // Creating a comprehensive document transfer "TO" audit entry
/// var transferAudit = new MatterDocumentActivityUserToDto
/// {
...
/// var validationResults = MatterDocumentActivityUserToDto.ValidateModel(transferAudit);
...
///                  $"{transferAudit.MatterDocumentActivity?.Activity?.ToLower()} to " +
///                  $"matter '{transferAudit.Matter?.Description}' by " +
///                  $"{transferAudit.User?.Name} on {transferAudit.LocalCreatedAtDateString}");
/// </code>
/// </example>
public record MatterDocumentActivityUserToDto : IValidatableObject, IEquatable<MatterDocumentActivityUserToDto>
{
    #region Composite Primary Key Properties

    /// <summary>
    /// Gets the unique identifier for the destination matter receiving the document.
    /// </summary>
    /// <remarks>
    /// This GUID serves as part of the composite primary key and identifies the matter that is receiving 
    /// the document through the transfer operation. It corresponds directly to 
    /// <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.MatterId"/> and must reference a valid, 
    ...
    /// <item><strong>Destination Identification:</strong> Identifies which matter is receiving the document</item>
    /// <item><strong>Foreign Key Reference:</strong> Must correspond to an existing Matter entity</item>
    /// <item><strong>Audit Trail Foundation:</strong> Essential for tracking document destinations</item>
    /// </list>
    /// 
    /// <para><strong>Legal Practice Significance:</strong></para>
    /// <list type="bullet">
    /// <item><strong>Matter Organization:</strong> Determines the matter-based organization destination for the document</item>
    /// <item><strong>Client Attribution:</strong> Links the document transfer to the appropriate client or case</item>
    ...
    /// This property mirrors <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.MatterId"/> exactly, 
    /// ensuring complete consistency between entity and DTO representations for reliable audit trail management.
    /// </remarks>
    /// <example>
    /// <code>
    /// // Setting destination matter for document transfer
    /// var transferAudit = new MatterDocumentActivityUserToDto
    /// {
    ...
    /// {
    ///     throw new ArgumentException("Destination matter ID is required for transfer audit");
    /// }
    /// 
    /// // Professional reporting usage
    /// Console.WriteLine($"Document transferred to matter ID: {transferAudit.MatterId}");
    /// </code>
    /// </example>
    [Required(ErrorMessage = "Destination matter ID is required for document transfer audit.")]
    public required Guid MatterId { get; init; }

    /// <summary>
    /// Gets the unique identifier for the document being transferred to the destination matter.
    /// </summary>
    /// <remarks>
    /// This GUID serves as part of the composite primary key and identifies the specific document that is 
    /// being transferred TO the destination matter. It corresponds directly to 
    /// <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.DocumentId"/> and must reference a valid, 
    ...
    /// <item><strong>COPY Operations:</strong> Document duplicated to destination matter while source retains copy</item>
    ...
    /// 
    /// <para><strong>Entity Alignment:</strong></para>
    /// This property mirrors <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.DocumentId"/> exactly, 
    ...
    /// var documentTransfer = new MatterDocumentActivityUserToDto
    /// {
    ///     MatterId = matterGuid,
    ...
    /// Console.WriteLine($"Tracking transfer of document ID: {documentTransfer.DocumentId}");
    /// 
    /// // Audit trail reporting
    /// if (documentTransfer.Document != null)
    /// {
    ///     Console.WriteLine($"Document '{documentTransfer.Document.FileName}' " +
    ///                      $"({documentTransfer.DocumentId}) transferred to matter");
    /// }
    /// </code>
    /// </example>
    ...
    /// <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.MatterDocumentActivityId"/> and must 
    ...
    /// 
    /// <para><strong>Entity Alignment:</strong></para>
    /// This property mirrors <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.MatterDocumentActivityId"/> exactly, 
    ...
    /// var moveOperation = new MatterDocumentActivityUserToDto
    /// {
    ///     MatterId = matterGuid,
    ///     DocumentId = documentGuid,
    ...
    /// <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.UserId"/> and provides essential user 
    ...
    /// 
    /// <para><strong>Entity Alignment:</strong></para>
    /// This property mirrors <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.UserId"/> exactly, 
    ...
    /// var transferWithUser = new MatterDocumentActivityUserToDto
    /// {
    ///     MatterId = matterGuid,
    ///     DocumentId = documentGuid,
    ///     MatterDocumentActivityId = activityGuid,
    ...
    /// <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.CreatedAt"/> and provides essential 
    ...
    /// 
    /// <para><strong>Entity Alignment:</strong></para>
    /// This property mirrors <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.CreatedAt"/> exactly, 
    ...
    /// var timestampedTransfer = new MatterDocumentActivityUserToDto
    /// {
    ///     MatterId = matterGuid,
    ///     DocumentId = documentGuid,
    ///     MatterDocumentActivityId = activityGuid,
    ...
    /// <summary>
    /// Gets the comprehensive matter details for the destination matter receiving the document.
    /// </summary>
    /// <remarks>
    /// This property provides complete matter information for the destination matter in the document 
    /// transfer operation, corresponding to the <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.Matter"/> 
    ...
    /// 
    /// <para><strong>Destination Matter Context:</strong></para>
    /// <list type="bullet">
    /// <item><strong>Transfer Destination:</strong> Complete information about where the document is being transferred</item>
    /// <item><strong>Matter Organization:</strong> Provides context for matter-based document organization</item>
    /// <item><strong>Professional Display:</strong> Enables professional presentation of transfer destinations</item>
    /// <item><strong>Client Communication:</strong> Supports client communication about document locations</item>
    /// </list>
    /// 
    ...
    /// <item><strong>Client Service:</strong> Enables effective client communication about matter organization</item>
    /// <item><strong>Professional Display:</strong> Provides professional presentation of matter information</item>
    /// <item><strong>Quality Assurance:</strong> Enables validation of appropriate matter destinations</item>
    /// </list>
    /// 
    /// <para><strong>Audit Trail Presentation:</strong></para>
    /// <list type="bullet">
    /// <item><strong>Complete Context:</strong> Provides complete destination context for audit trail reports</item>
    ...
    /// <example>
    /// <code>
    /// // Complete destination matter information
    /// var transferWithMatter = new MatterDocumentActivityUserToDto
    /// {
    ///     MatterId = matterGuid,
    ///     Matter = new MatterWithoutDocumentsDto
    ///     {
    ...
    /// {
    ///     Console.WriteLine($"Document transferred to matter: '{transferWithMatter.Matter.Description}' " +
    ///                      $"(Status: {transferWithMatter.Matter.Status})");
    /// }
    /// 
    /// // Professional client communication
    /// var destinationDescription = transferWithMatter.Matter?.DisplayText ?? "Unknown Matter";
    /// Console.WriteLine($"Your document has been organized under: {destinationDescription}");
    /// </code>
    /// </example>
    public MatterWithoutDocumentsDto? Matter { get; init; }

    /// <summary>
    /// Gets the comprehensive document details for the document being transferred to the destination matter.
    /// </summary>
    /// <remarks>
    /// This property provides complete document information for the document being transferred in the operation, 
    /// corresponding to the <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.Document"/> navigation property. 
    ...
    /// <para><strong>Transfer Operation Context:</strong></para>
    /// <list type="bullet">
    /// <item><strong>MOVE Operations:</strong> Document being relocated to the destination matter</item>
    /// <item><strong>COPY Operations:</strong> Document being duplicated to the destination matter</item>
    ...
    /// var transferWithDocument = new MatterDocumentActivityUserToDto
    /// {
    ///     DocumentId = documentGuid,
    ///     Document = new DocumentWithoutRevisionsDto
    ///     {
    ...
    ///                      $"transferred to destination matter");
    /// }
    /// 
    /// // Client communication
    /// var documentName = transferWithDocument.Document?.FileName ?? "Unknown Document";
    /// Console.WriteLine($"Your document '{documentName}' has been successfully organized");
    /// </code>
    /// </example>
    ...
    /// corresponding to the <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.MatterDocumentActivity"/> 
    ...
    /// <item><strong>COPIED:</strong> Document duplicated to destination matter while source retains original</item>
    ...
    /// var transferWithActivity = new MatterDocumentActivityUserToDto
    /// {
    ///     MatterDocumentActivityId = activityGuid,
    ///     MatterDocumentActivity = new MatterDocumentActivityDto
    ///     {
    ...
    ///     };
    ///     
    ///     Console.WriteLine($"User {operationDescription} the document to the destination matter");
    /// }
    /// 
    ...
    /// transfer operation, corresponding to the <see cref="ADMS.API.Entities.MatterDocumentActivityUserTo.User"/> 
    ...
    /// <example>
    /// <code>
    /// var transfer = new MatterDocumentActivityUserToDto 
    /// { 
    ...
    /// // Returns: "Contract.pdf MOVED to Client ABC Matter by Robert Brown"
    /// 
    ...
    /// <summary>
    /// Validates the <see cref="MatterDocumentActivityUserToDto"/> for data integrity and business rules compliance.
    /// </summary>
    ...
    /// ADMS.API.Entities.MatterDocumentActivityUserTo entity while enforcing audit trail-specific business rules.
    /// 
    ...
    private IEnumerable<ValidationResult> ValidateGuids()
    {
        if (MatterId == Guid.Empty)
            yield return new ValidationResult(
                "Destination matter ID must be a valid non-empty GUID for audit trail integrity.",
                [nameof(MatterId)]);
    ...
    private IEnumerable<ValidationResult> ValidateMatter()
    {
        ...
        foreach (var result in validatable.Validate(context))
            yield return new ValidationResult($"Destination Matter: {result.ErrorMessage}", result.MemberNames);
    }
    ...
    /// <summary>
    /// Validates a <see cref="MatterDocumentActivityUserToDto"/> instance and returns detailed validation results.
    /// </summary>
    /// <param name="dto">The MatterDocumentActivityUserToDto instance to validate. Can be null.</param>
    /// <returns>A list of validation results indicating any validation failures.</returns>
    /// <remarks>
    /// This static helper method provides a convenient way to validate MatterDocumentActivityUserToDto instances
    ...
    /// };
    /// 
    /// var results = MatterDocumentActivityUserToDto.ValidateModel(dto);
    /// if (results.Any())
    /// {
    ...
    public static IList<ValidationResult> ValidateModel([AllowNull] MatterDocumentActivityUserToDto? dto)
    {
        ...
        if (dto is null)
        {
            results.Add(new ValidationResult("MatterDocumentActivityUserToDto instance is required and cannot be null."));
            return results;
        }
    ...
    /// <summary>
    /// Creates a MatterDocumentActivityUserToDto from ADMS.API.Entities.MatterDocumentActivityUserTo entity with validation.
    /// </summary>
    ...
    /// <returns>A valid MatterDocumentActivityUserToDto instance.</returns>
    /// <exception cref="ArgumentNullException">Thrown when entity is null.</exception>
    /// <exception cref="ValidationException">Thrown when the resulting DTO fails validation.</exception>
    /// <remarks>
    /// This factory method provides a safe way to create MatterDocumentActivityUserToDto instances from
    /// ADMS.API.Entities.MatterDocumentActivityUserTo entities with automatic validation. It ensures the 
    ...
    /// };
    /// 
    /// var dto = MatterDocumentActivityUserToDto.FromEntity(entity, includeNavigationProperties: true);
    /// </code>
    /// </example>
    public static MatterDocumentActivityUserToDto FromEntity([NotNull] Entities.MatterDocumentActivityUserTo entity, bool includeNavigationProperties = false)
    {
        ...
        throw new ValidationException($"Failed to create valid MatterDocumentActivityUserToDto from entity: {errorMessages}");
    ...
    /// </summary>
    /// <param name="entities">The collection of MatterDocumentActivityUserTo entities to convert. Cannot be null.</param>
    /// <param name="includeNavigationProperties">Whether to include navigation properties in the conversion.</param>
    /// <returns>A collection of valid MatterDocumentActivityUserToDto instances.</returns>
    ...
    /// var entities = await context.MatterDocumentActivityUsersTo.ToListAsync();
    /// var transferAuditDtos = MatterDocumentActivityUserToDto.FromEntities(entities, includeNavigationProperties: false);
    /// 
    /// // Process audit trail
    ...
    /// </code>
    /// </example>
    public static IList<MatterDocumentActivityUserToDto> FromEntities([NotNull] IEnumerable<Entities.MatterDocumentActivityUserTo> entities, bool includeNavigationProperties = false)
    {
    ...
    /// </summary>
    /// <param name="matterId">The destination matter ID.</param>
    ...
    /// var transferAudit = MatterDocumentActivityUserToDto.CreateTransferAudit(
    ///     destinationMatterId,
    ///     documentId,
    ///     moveActivityId,
    ///     userId);
    ...
    ///     Console.WriteLine($"Document custody transferred TO {transferAudit.Matter?.Description}");
    /// }
    /// </code>
    /// </example>
    ...
    /// {
    ///     // Document duplicated - both source and destination have document
    ///     Console.WriteLine($"Document copied TO {transferAudit.Matter?.Description}");
    /// }
    /// </code>
    /// </example>
    ...
    /// // Returns: "On Monday, 15 January 2024 14:30:45, Robert Brown MOVED Contract.pdf TO Client ABC Matter"
    /// 
    ...
    /// <summary>
    /// Determines whether the specified MatterDocumentActivityUserToDto is equal to the current MatterDocumentActivityUserToDto.
    /// </summary>
    /// <param name="other">The MatterDocumentActivityUserToDto to compare with the current MatterDocumentActivityUserToDto.</param>
    /// <returns>true if the specified MatterDocumentActivityUserToDto is equal to the current MatterDocumentActivityUserToDto; otherwise, false.</returns>
    /// <remarks>
    ...
    /// </remarks>
    public virtual bool Equals(MatterDocumentActivityUserToDto? other)
    {
    ...
    /// </summary>
    /// <returns>A hash code for the current MatterDocumentActivityUserToDto.</returns>
    /// <remarks>
    ...
    /// <summary>
    /// Returns a string representation of the MatterDocumentActivityUserToDto.
    /// </summary>
    /// <returns>A string that represents the current MatterDocumentActivityUserToDto.</returns>
    /// <remarks>
    ...
    /// // Output: "Transfer TO: Document (70000000-0000-0000-0000-000000000001) → Matter (60000000-0000-0000-0000-000000000001) by User (50000000-0000-0000-0000-000000000001)"
    /// </code>
    /// </example>
